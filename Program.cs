...
Console.WriteLine("All Place Names");
  ...
  string tt = @"Look again at that dot. That's here. That's home. That's us. On it everyone you love, everyone 
  ...
  The aggregate of our joy and suffering, thousands of confident religions, ideologies, and economic
   doctrines, every hunter and forager, every hero and coward,
    ...
    corner of this pixel on the scarcely distinguishable inhabitants of some other corner, how frequent
     their misunderstandings, how eager they are to kill one another, how fervent their hatreds.
    ...
    future, to which our species could migrate. Visit, yes. Settle, not yet. Like it or not, for the moment
...
string Qoute = Regex.Replace(tt, "/[^a-zA-Z ]/g", " ");
 List<string> words = Qoute.Split(" ").ToList();
